...
router.post("/users/:userId/adjust-balance", async (req, res, next) => {
  try {
...
router.patch("/pricing-rules/:ruleId", async (req, res, next) => {
  try {
...
router.delete("/pricing-rules/:ruleId", async (req, res, next) => {
  try {
...
router.patch("/providers/:providerId", async (req, res, next) => {
  try {
